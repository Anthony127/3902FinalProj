...
{
    public class CrouchFireMarioRightSprite : Sprite, ISprite
    {
        public CrouchFireMarioRightSprite(Texture2D spriteSheet) : base(spriteSheet)
        {
        }

        protected override Rectangle GetSourceRectangle()
        {
            return new Rectangle(288, 466, 16, 32);
        }
